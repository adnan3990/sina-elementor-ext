 ...
 * Plugin URI: https://github.com/shaonsina/sina-elementor-ext
 * Text Domain: sina
 */
...
final class Sina_Extension {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'sina' ),
			'<strong>' . esc_html__( 'Sina Extension for Elementor', 'sina' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'sina' ) . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'sina' ),
			'<strong>' . esc_html__( 'Sina Extension for Elementor', 'sina' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'sina' ) . '</strong>',
	...
	public function admin_notice_minimum_php_version() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'sina' ),
			'<strong>' . esc_html__( 'Sina Extension for Elementor', 'sina' ) . '</strong>',
			'<strong>' . esc_html__( 'PHP', 'sina' ) . '</strong>',
	...
	public function widget_scripts() {
		...
		wp_register_script( 'jquery-particle', SINA_EXT_URL .'assets/js/jquery-particle.min.js', ['jquery'], SINA_EXT_VERSION, true );
	...
	public function init_widgets() {
		...
		require_once( SINA_EXT_DIR .'/widgets/sina-icon-box.php' );
		...
		Plugin::instance()->widgets_manager->register_widget_type( new Sina_Icon_Box_Widget() );
