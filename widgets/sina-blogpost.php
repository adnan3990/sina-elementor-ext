...
class Sina_Blogpost_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'title_tag',
			[
				'label' => __( 'Select Title Tag', 'sina-ext' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => __( 'h1', 'sina-ext' ),
					'h2' => __( 'h2', 'sina-ext' ),
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name' => 'pagi_link_hover_border',
				'selector' => '{{WRAPPER}} .sina-bp-pagination .page-numbers:hover, {{WRAPPER}} .sina-bp-pagination .page-numbers:focus',
				'separator' => 'before',
			]
		);
		$this->end_controls_tab();
						...
						<div class="sina-bp-col <?php echo esc_attr( $data['columns'] ) ?>">
							<div class="sina-bp">
								...
								<div class="sina-bp-content">
									<<?php echo esc_html( $data['title_tag'] ); ?> class="sina-bp-title">
										<a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
									</<?php echo esc_html( $data['title_tag'] ); ?>>
									<div class="sina-bp-text">
										<?php
											if ( has_excerpt() && $data['excerpt'] ):
