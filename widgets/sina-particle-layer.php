...
class Sina_Particle_Layer_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sina-banner-pbtn .sina-bbtn-right' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .sina-banner-pbtn .sina-bbtn-left' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .sina-banner-sbtn .sina-bbtn-right' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .sina-banner-sbtn .sina-bbtn-left' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .sina-banner-pbtn:hover, {{WRAPPER}} .sina-banner-pbtn:focus' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .sina-banner-sbtn:hover, {{WRAPPER}} .sina-banner-sbtn:focus' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		<div class="sina-particle-layer">
						...
						<?php if ( $data['pbtn_text'] ): ?>
							...
							role="button">
								<?php if ( $data['pbtn_icon'] && $data['pbtn_icon_align'] == 'left' ): ?>
									<i class="<?php echo esc_attr($data['pbtn_icon']); ?> sina-bbtn-left"></i>
								<?php endif; ?>
								...
								<?php if ( $data['pbtn_icon'] && $data['pbtn_icon_align'] == 'right' ): ?>
									<i class="<?php echo esc_attr($data['pbtn_icon']); ?> sina-bbtn-right"></i>
								<?php endif; ?>
							</a>
						<?php endif ?>
						...
						<?php if ( $data['sbtn_text'] ): ?>
							...
							role="button">
								<?php if ( $data['sbtn_icon'] && $data['sbtn_icon_align'] == 'left' ): ?>
									<i class="<?php echo esc_attr($data['sbtn_icon']); ?> sina-bbtn-left"></i>
								<?php endif; ?>
								...
								<?php if ( $data['sbtn_icon'] && $data['sbtn_icon_align'] == 'right' ): ?>
									<i class="<?php echo esc_attr($data['sbtn_icon']); ?> sina-bbtn-right"></i>
								<?php endif; ?>
							</a>
						<?php endif ?>
					</div>
			...
			data-color="<?php echo esc_attr( $data['particle_color']); ?>"
		...
		<div class="sina-particle-layer">
			<div class="sina-banner-container">
				...
				<# if ( settings.subtitle ) { #>
					<div {{{ view.getRenderAttributeString( 'subtitle' ) }}}>
						{{{settings.subtitle}}}
					</div>
				<# } #>
				...
				<div class="sina-banner-btns">
					<# if ( settings.pbtn_text ) { #>
						<a class="sina-banner-pbtn"
						href="{{{settings.pbtn_link.url}}}">
						<# if ( settings.pbtn_icon && settings.pbtn_icon_align == 'left' ) { #>
							<i class="{{{settings.pbtn_icon}}} sina-bbtn-left"></i>
						<# } #>
						<span {{{ view.getRenderAttributeString( 'pbtn_text' ) }}}>
							{{{settings.pbtn_text}}}
						</span>
						<# if ( settings.pbtn_icon && settings.pbtn_icon_align == 'right' ) { #>
							<i class="{{{settings.pbtn_icon}}} sina-bbtn-left"></i>
						<# } #>
						</a>
					<# } #>
					...
					<# if ( settings.sbtn_text ) { #>
						...
						<# if ( settings.sbtn_icon && settings.sbtn_icon_align == 'left' ) { #>
							<i class="{{{settings.sbtn_icon}}} sina-bbtn-left"></i>
						<# } #>
						<span {{{ view.getRenderAttributeString( 'sbtn_text' ) }}}>
							{{{settings.sbtn_text}}}
						</span>
						<# if ( settings.sbtn_icon && settings.sbtn_icon_align == 'right' ) { #>
							<i class="{{{settings.sbtn_icon}}} sina-bbtn-left"></i>
						<# } #>
						</a>
					<# } #>
			...
			<div class="sina-particle"
			data-color="{{{settings.particle_color}}}"
			data-number="{{{settings.particle_number}}}"
			data-link="{{{settings.particle_link}}}"
			data-clink="{{{settings.particle_create_link}}}"
			data-linkw="{{{settings.particle_link_width}}}"
			data-size="{{{settings.particle_ball}}}"
			data-speed="{{{settings.anim_speed}}}"
			data-dlink="{{{settings.link_state}}}"
